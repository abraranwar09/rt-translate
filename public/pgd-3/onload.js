document.addEventListener('DOMContentLoaded', () => {
    ...
    if (!inputLanguageSelect || !outputLanguageSelect || !menuButton || !languageMenu) {
    ...
    inputLanguageSelect.value = localStorage.getItem('input_language');
    outputLanguageSelect.value = localStorage.getItem('output_language');
    document.getElementById('langText').innerHTML = localStorage.getItem('input_language') + 'المدخل' + '<br>' + localStorage.getItem('output_language') + ' المخرج ';
