...
function configureTools() {
    if (dc && dc.readyState === "open") {
        ...
        animation.play();
        //listening
        document.getElementById("mainText").innerHTML = "المترجم الذكي يستمع الآن";
        document.getElementById("subText").innerHTML = "تحدث فقط وسأساعدك في الترجمة";
      } else {
        console.error("Data channel is not open");
      }
}
...
document.getElementById("talkButton").addEventListener("click", () => {
  if (pc && pc.connectionState === "connected") {
    ...
    animation.stop();
    //paused
    document.getElementById("mainText").innerHTML = "تم إيقاف المترجم مؤقتًا";
    document.getElementById("subText").innerHTML = "انقر على زر التحدث للبدء من جديد أو غيّر اللغة من القائمة في أعلى اليمين";
  } else {
    init();
    //loading
    document.getElementById("mainText").innerHTML = "جارٍ تحميل المترجم الذكي";
    document.getElementById("subText").innerHTML = "يرجى الانتظار أثناء تهيئة المترجم";
  }
});
